...
global.owner = process.env.OWNER_NUMBER  || '+447419773574' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID |VAJIRA-MD=7YcWAYTb#iVB5i9rJ_J0KF5UZLVAFQ26vPo0ql5KrQlswwygtyMU| 'youre session id' ,
